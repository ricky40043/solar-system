        ...
        <div className="enter-destinations">
          ...
          <div className="enter-destination-grid">
            {destinationItems.map((item) => (
              ...
              >
                <span className="enter-destination-orb"></span>
                <span className="enter-destination-name">{item.name}</span>
                <svg className="enter-destination-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><path d="M5 12h14"/><path d="M13 6l6 6-6 6"/></svg>
              </button>
            ))}
          </div>
        </div>
